...
def gesture_game_quiz(np_frame , rightAnswer):
    ...
    print('------  ',np_frame.shape , 'f number - ',fnumb, '  rightAnswer  ',rightAnswer ,'   ---------------------------------------')
...
def handle_stream(data):
    ...
    if data['nameOftheTest'] == "StreamThree" and data['levelofmcq'] == "q4":
        ...
        answerText , mark , aireply , streamNumber , isAnswerOk =  gesture_game_quiz(image , data['rightAnswer'])
    ...
    #! stream mcqs
        ...
        if nameOftheTest == "StreamOne":
            ...
            if levelofmcq == "q1":
                ...
                print('in the mcq answer ql and return the text of answer ---  - ',answerText)
                print('in the mcq answer ql and return the text of mark ---  - ',mark)
...
def answer_by_speech():
    ...
    try:
        ...
        if os.path.exists(path_audio):
            ...
            answerProceesed , mark , aireply , streamNumber= process_speech_ai_ques(nameOftheTest, levelofmcq , rightanswer,parth,userspeachtotext)
